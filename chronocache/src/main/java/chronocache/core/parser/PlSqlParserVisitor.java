...
public interface PlSqlParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link PlSqlParser#dml_compilation_unit}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDml_compilation_unit(PlSqlParser.Dml_compilation_unitContext ctx);
	/**
	 * Visit a parse tree produced by {@link PlSqlParser#seq_of_dml_statements}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSeq_of_dml_statements(PlSqlParser.Seq_of_dml_statementsContext ctx);
	/**
