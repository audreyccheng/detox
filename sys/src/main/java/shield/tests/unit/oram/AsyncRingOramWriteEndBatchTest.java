...
import com.amazonaws.services.simplesystemsmanagement.model.TooManyTagsErrorException;
...
public class AsyncRingOramWriteEndBatchTest {
  ...
  public static void main(String[] args) {
    ...
    AsyncRingOram oram = AsyncRingOram.create(r, backingStore, 4, CONFIG);
    ISyncBackingStore syncBackingStore = new SyncAsyncBackingStore(oram);
    BackingStoreTest.testBatchSequence(CONFIG.MAX_NB_STRIDE * CONFIG.STRIDE_SIZE + CONFIG.WRITES_SIZE, 25, r, syncBackingStore, CONFIG.ORAM_VALUE_SIZE);
    oram.shutdown();
  }
}
